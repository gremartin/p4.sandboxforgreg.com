...
# What is the name of this app?
	define('APP_NAME', 'Boston Historical Image Database');  
...
# Default DB name for this app
	define('DB_NAME', 'sandboxf_p4_sandboxforgreg_com'); 
...
# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', 'GlRra58OPXgFe#gc*&HMKeSbi5MALsay)A*m1mUF');
	define('TOKEN_SALT', 'PiNQFf&$t3#1T4KT8h#mP&GS)cE2V%LUfO_5vx^h');